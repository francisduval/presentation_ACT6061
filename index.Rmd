...
background-image: url("images/deep_learning.png")
...
- Exemples de fonctions de perte:
  ...
  \end{align}
- Le but est alors de minimiser la fonction de perte moyenne sur l'ensemble d'entrainement. On voudra donc trouver les paramètres qui minimisent $\frac{1}{n}\sum_{i=1}^n \ell(y_i, \widehat{y}_i)$.
