...
# Application à la tarification avec données télématiques
...
**Supposons que l'on veule faire de la tarification par véhicule. On pourrait alors créer « à la main » plusieurs variables explicatives, ou features, avec les données télématiques. Par exemple:**
